...
test("promotion materialization consumes the sole production Buildchain job", () => {
  ...
  assert.match(
    workflow,
    /uses: kungfu-systems\/buildchain\/\.github\/workflows\/\.declarative-auditable-demo\.yml@b88097b5e562b4f49cdef3ddee81be6eab5224a2/u,
  );
...
test("repository invokes only the exact reviewed Buildchain v4 authority", () => {
  ...
  const authority = "b88097b5e562b4f49cdef3ddee81be6eab5224a2";
  for (const relative of [
    ".github/workflows/build.yml",
    ".github/workflows/buildchain-ref-promotion.yml",
    ".github/workflows/verify.yml",
